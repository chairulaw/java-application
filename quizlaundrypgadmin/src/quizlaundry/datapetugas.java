...
import static quizlaundry.petugas.alamat;
import static quizlaundry.petugas.idpetugas;
import static quizlaundry.petugas.namapetugas;
import static quizlaundry.petugas.nohp;
import static quizlaundry.petugas.status;
import static quizlaundry.petugas.tgllahir;
import static quizlaundry.petugas.umur;
/**
 *
 * @author CHAIRULAW
 */
...
public DatabaseConnection datapetugasdatabaseConnection;
    /**
     * Creates new form datapetugas
     */
    public datapetugas() {
         initComponents();
        datapetugasdatabaseConnection = new DatabaseConnection();
        datapetugasdatabaseConnection.koneksi();
        conn = datapetugasdatabaseConnection.getConnection();
        cn = datapetugasdatabaseConnection.getStatement();
        tampildata();
    }
    ...
    private void datapetugasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datapetugasMouseClicked
        // TODO add your handling code here:
        int row;
        row = datapetugas.getSelectedRow();
       row = datapetugas.getSelectedRow();
            idpetugas.setText(datapetugas.getValueAt(row, 0).toString());
            namapetugas.setText(datapetugas.getValueAt(row, 1).toString());
            tgllahir.setText(datapetugas.getValueAt(row, 2).toString());
            alamat.setText(datapetugas.getValueAt(row, 3).toString());
            nohp.setText(datapetugas.getValueAt(row, 4).toString());
            umur.setText(datapetugas.getValueAt(row, 5).toString());
            status.setText(datapetugas.getValueAt(row, 6).toString());
        this.dispose();
