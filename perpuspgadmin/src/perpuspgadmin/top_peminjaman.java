 ...
 * @author CHAIRULAW
 */
public class top_peminjaman extends javax.swing.JFrame {
public Connection conn;
private java.sql.Statement cn;
public DatabaseConnection datatopdatabaseConnection;
    /**
     * Creates new form top_peminjaman
     */
    public top_peminjaman() {
        initComponents();
        datatopdatabaseConnection = new DatabaseConnection();
        datatopdatabaseConnection.koneksi();
        conn = datatopdatabaseConnection.getConnection();
        cn = datatopdatabaseConnection.getStatement();
        tampildata();
    }
    ...
    try{
    datatopdatabaseConnection.koneksi();
    String sql = "SELECT * FROM top_peminjaman";
    ...
    private void initComponents() {
        ...
        datatop = new javax.swing.JTable();
        ...
        jLabel15.setText("Top Peminjaman");

        datatop.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        datatop.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                datatopMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(datatop);
    ...
    private void datatopMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datatopMouseClicked
        // TODO add your handling code here:
        int row;
        row = datatop.getSelectedRow();
        Buku.idbuku.setText(datatop.getValueAt(row, 0).toString());
        Buku.namabuku.setText(datatop.getValueAt(row, 1).toString());
        Buku.stokbuku.setText(datatop.getValueAt(row, 2).toString());
        this.dispose();
    }//GEN-LAST:event_datatopMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(top_peminjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new top_peminjaman().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable datatop;
