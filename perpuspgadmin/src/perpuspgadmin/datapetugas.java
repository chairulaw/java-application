...
import static perpuspgadmin.petugas.alamat;
import static perpuspgadmin.petugas.idpetugas;
import static perpuspgadmin.petugas.namapetugas;
import static perpuspgadmin.petugas.nohp;
/**
 *
 * @author CHAIRULAW
 */
...
public DatabaseConnection datapetugasdatabaseConnection;
    ...
    private void datapetugasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datapetugasMouseClicked
        ...
        peminjaman.idpetugas.setText(datapetugas.getValueAt(row, 0).toString());
        peminjaman.namapetugas.setText(datapetugas.getValueAt(row, 1).toString());
        peminjaman.nohp.setText(datapetugas.getValueAt(row, 2).toString());
        peminjaman.alamat.setText(datapetugas.getValueAt(row, 3).toString());
        this.dispose();
